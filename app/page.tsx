  ...
  return (
    <main>
      ...
      {stage === 'choose' && <section className="choose-stage">
        <div className="stage-heading"><p className="kicker">LISTEN TO YOUR FIRST INSTINCT</p><h1>憑直覺，選出 {currentSpread.count} 張牌</h1><p>桌面將游標移過牌扇即可放大；手機輕點一次讓牌升起，再點同一張完成選取。</p></div>
